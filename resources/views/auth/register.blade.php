        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header"><h1 style="margin-left:12rem;">{{ __('Inscrivez-Vous') }}</h1></div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-start">{{ __('Confirm ') }}</label>
                        ...
                        <div class="row mb-0">
                            ...
                            <!--
                                <button type="submit" class="btn btn-primary">
                                    <a href="{{ route('login') }}" style="color:white;text-decoration:none;">a>
                                </button>
                            -->
                            </div>
                        </div>
